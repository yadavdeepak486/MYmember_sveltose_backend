const addfolderModal = require('../models/createfolder'); // folder create modal
const documentModal = require('../models/createdoucment') // create document modal
...
exports.createDocument = (req,res)=>{
    var folder_name = req.body.folder_name;
    var document_name = req.body.doc_name;
