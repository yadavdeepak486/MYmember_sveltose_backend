...
router.update("/membership/update_buy_memberships/:user_id/:membershipId",parser,requireSignin,buy_membership.update);
router.delete("/membership/delete_buy_membership/:user_id/:membershipId",parser,requireSignin,buy_membership.remove);
