...
router.put("/update_events/:user_id/:eventId",parser,requireSignin,events.update);
router.delete("/delete_events/:user_id/:eventId",parser,requireSignin,events.remove);
